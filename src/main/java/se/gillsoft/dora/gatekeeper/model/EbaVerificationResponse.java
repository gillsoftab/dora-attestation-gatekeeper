package se.gillsoft.dora.gatekeeper.model;
...
@Data
@Builder
public class EbaVerificationResponse {
     ...
     * In production, EBA would use its own qualified electronic seal
     * under eIDAS Regulation (EU) No 910/2014.
     */
    private String ebaSignature;

    /**
     * The certificate (PEM) of the key used to sign this receipt,
     * so that the signature can be verified independently.
     */
    private String ebaSigningCertificate;
